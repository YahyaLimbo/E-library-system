...
MATERIALTAGID SERIAL NOT NULL PRIMARY KEY,
MATERIALID BIGINT NOT NULL,
TYPE VARCHAR(50) NOT NULL (TYPE IN ('book', 'journal', 'magazine', 'newspaper', 'researchpaper',
        'Magazine', 'Thesis', 'ConferencePaper', 'Referencematerial',
        'database', 'Archive', 'dataset', 'audioBook'),
TAGS JSONB DEFAULT '[]'::jsonb
FOREIGN KEY(MATERIALID) REFERENCES MATERIAL(MATERIALID) ON DELETE CASCADE ON UPDATE CASCADE, 
FOREIGN KEY(TYPE) REFERENCES MATERIAL(TYPE) ON DELETE CASCADE ON UPDATE CASCADE
);